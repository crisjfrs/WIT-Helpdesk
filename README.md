...
- **Project Laravel**: `/home/kioa5176/laravel_ticketone`
- **Public Folder**: `/home/kioa5176/public_html/demo-ticketonepro.kioskoding.com`

**Langkah-langkah:**

1. **Masuk ke folder public:**
```bash
cd /home/kioa5176/public_html/demo-ticketonepro.kioskoding.com
```

2. **Buat symlink dengan path absolut:**
```bash
ln -s /home/kioa5176/laravel_ticketone/storage/app/public storage
```
...
```
lrwxrwxrwx 1 kioa5176 kioa5176 50 Jan 26 12:00 storage -> /home/kioa5176/laravel_ticketone/storage/app/public
```
...
```
total 8
drwxr-xr-x 2 kioa5176 kioa5176 4096 Jan 26 12:00 .
drwxr-xr-x 3 kioa5176 kioa5176 4096 Jan 26 12:00 ..
drwxr-xr-x 2 kioa5176 kioa5176 4096 Jan 26 12:00 tickets
drwxr-xr-x 2 kioa5176 kioa5176 4096 Jan 26 12:00 messages
```
...
**Output yang diharapkan:**
```
/home/kioa5176/laravel_ticketone/storage/app/public
```

6. **Test akses file melalui browser:**
Setelah symlink berhasil, file yang diupload akan dapat diakses via URL:
```
http://demo-ticketonepro.kioskoding.com/storage/tickets/nama-file.jpg
```
...
```bash
ls -la /home/kioa5176/laravel_ticketone/storage/app/public
```

2. **Cek permission folder:**
```bash
ls -ld /home/kioa5176/laravel_ticketone/storage/app/public
ls -ld /home/kioa5176/public_html/demo-ticketonepro.kioskoding.com
```

3. **Hapus symlink yang rusak dan buat ulang:**
```bash
# Hapus symlink yang ada
rm /home/kioa5176/public_html/demo-ticketonepro.kioskoding.com/storage
...
file storage
# Output harus: "storage: symbolic link to /home/kioa5176/laravel_ticketone/storage/app/public"

# Jika output "broken symbolic link", berarti path target salah atau tidak ada
```

**Catatan Penting:**
- Pastikan folder `/home/kioa5176/laravel_ticketone/storage/app/public` sudah ada
